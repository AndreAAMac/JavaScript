class Character{
    ...
    //Sempre que quiser chamar o nome dele
    constructor(name) {
        this.name = name;
    }
...
class Stage{
    ...
    doAttack(attacking, attacked){
        ...
        this.update();
        //alert(actualAttack);
        //alert(`${attacking.name} está atacando ${attacked.name}`);
    }
}
